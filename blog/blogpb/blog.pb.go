...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x32, 0x54,
	0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x45, 0x0a,
	...
	0x28, 0x01, 0x30, 0x01, 0x42, 0x0d, 0x5a, 0x0b, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x62, 0x6c, 0x6f,
...
func (c *blogServiceClient) CreateBlog(ctx context.Context, opts ...grpc.CallOption) (BlogService_CreateBlogClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BlogService_serviceDesc.Streams[0], "/blog.BlogService/CreateBlog", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *blogServiceCreateBlogClient) Recv() (*CreateBlogResponse, error) {
...
func (*UnimplementedBlogServiceServer) CreateBlog(BlogService_CreateBlogServer) error {
...
func (x *blogServiceCreateBlogServer) Send(m *CreateBlogResponse) error {
